	...
	const items = [
		{
			...
			tallyExamples: [
				...
				{ tallyTitle: 'Kilómetros corridos', tallyDescription: 'Kilómetros totales corridos' }
			]
		},
		{
			...
			{#each items as item, i (i)}
				<Carousel.Item>
					<div class="p-1">
						...
						<div class="align-center flex flex-row flex-wrap justify-around gap-12">
